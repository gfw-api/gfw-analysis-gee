...
def composite(geojson, instrument, date_range, thumb_size, classify, band_viz, get_dem, get_stats, show_bounds, cloudscore_thresh):
    """
...
def get_by_hash(geojson, area_ha, instrument, date_range, thumb_size, classify, band_viz, get_dem, get_stats, show_bounds, cloudscore_thresh):
    """Get composite image for given geostore"""
    logging.info('[ROUTER - composite]: Getting area by id hash')
    return composite(geojson, instrument, date_range, thumb_size, classify, band_viz, get_dem, get_stats, show_bounds, cloudscore_thresh)


@composite_service_v1.route('/geom/', strict_slashes=False, methods=['GET','POST'])
@get_geo_by_geom
@get_composite_params
def get_by_geom(geojson, area_ha, instrument, date_range, thumb_size, classify, band_viz, get_dem, get_stats, show_bounds, cloudscore_thresh):
